...
class TestTrackedOpenAI:
    ...
    def test_initialization_invalid_api_key(self):
        ...
        client = TrackedOpenAI(api_key="invalid-key", tracker_key=self.valid_tracker_key)
        assert client is not None
    
    @patch('cmdrdata_openai.client.OpenAI')
    @patch('cmdrdata_openai.client.UsageTracker')
    def test_initialization_custom_endpoint(self, mock_tracker_class, mock_openai_class):
    ...
    @patch('cmdrdata_openai.client.OpenAI')
    @patch('cmdrdata_openai.client.UsageTracker')
    def test_check_compatibility_raise_on_incompatible(self, mock_tracker_class, mock_openai_class):
...
class TestTrackedOpenAIIntegration:
    ...
    @patch('cmdrdata_openai.client.OpenAI')
    @patch('cmdrdata_openai.client.UsageTracker')
    def test_tracked_method_with_usage_tracking(self, mock_tracker_class, mock_openai_class):
    ...
    @patch.dict(os.environ, {'OPENAI_API_KEY': 'sk-test123', 'CMDRDATA_API_KEY': 'tk-test123'})
    @patch('cmdrdata_openai.client.OpenAI')
    @patch('cmdrdata_openai.client.UsageTracker')
    def test_environment_variable_initialization(self, mock_tracker_class, mock_openai_class):
