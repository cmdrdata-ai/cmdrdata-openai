...
from cmdrdata_openai.proxy import (
    TrackedProxy, track_chat_completion, track_completion, OPENAI_TRACK_METHODS
)
...
class TestTrackingFunctions:
    ...
    def test_track_chat_completion_success(self):
        ...
        with patch('cmdrdata_openai.proxy.get_effective_customer_id') as mock_get_customer:
